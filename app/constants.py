...
initial_email_template_html = {
    ...
    "body": "Hello,<br><br>IGO has completed %s QC on project %s. <br><br>Please proceed to <a href='https://igodev.mskcc.org/sample-qc/report/%s'>igo.mskcc.org/sample-qc/report/%s</a> to ask any questions, download related documents, and to indicate which sample(s) should continue with processing.<br><br>Thank you,",
...
notification_email_template_html = {
    "from": "igoski@mskcc.org",
    "subject": "[SampleQC Beta-Test] %s New Comment",
    "body": "Hello,<br><br>The following comment has been added to %s QC on project %s by %s.<br><br>\"%s\"<br><br>Please proceed to <a href='https://igodev.mskcc.org/sample-qc/report/%s'>igo.mskcc.org/sample-qc/report/%s</a> if you would like to reply.<br><br>Thank you,",
