...
initial_email_template_html = {
    "from": "igoski@mskcc.org",
    "subject": "[SampleQC Beta-Test] %s QC results, %s",
...
notification_email_template_html = {
    "from": "igoski@mskcc.org",
    "subject": "[SampleQC Beta-Test] %s New Comment",
    "body": "Hello,<br><br>The following comment has been added to %s QC on project %s by %s.<br><br>\"%s\"<br><br>Please proceed to <a href='https://igo.mskcc.org/sample-qc'>igo.mskcc.og/sample-qc</a> and search for your project if you would like to reply.<br><br>Thank you,",
